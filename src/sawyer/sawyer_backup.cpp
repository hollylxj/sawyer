...
static std::string PY_JOINT_TORQUES_COMMANDED_KEY = "py::robot::" + robot_name + "::actuators::fgc";

// - read:
static std::string PY_JOINT_ANGLES_KEY         = "py::robot::" + robot_name + "::sensors::q";
static std::string PY_JOINT_VELOCITIES_KEY = "py::robot::" + robot_name + "::sensors::dq";
static std::string PY_EE_POSITION_KEY = "py::robot::" + robot_name + "::tasks::ee_pos";
static std::string PY_EE_DES_POSITION_KEY = "py::robot::" + robot_name + "::tasks::ee_pos_des";
static std::string PY_EE_DES_ORIENTATION_KEY = "py::robot::" + robot_name + "::tasks::ee_ori_des";
static std::string PY_Q_READY = "py::robot::" + robot_name + "::tasks::q_flag";
static std::string PY_TORQUE_READY = "py::robot::" + robot_name + "::tasks::torque_flag";
static std::string TIMESTAMP_KEY = "cs225a::robot::" + robot_name + "::timestamp";
...
Eigen::VectorXd calcTorque(Eigen::Matrix3d R_des, Eigen::Vector3d x_des, int dof, Model::ModelInterface* robot, Eigen::VectorXd& g);
...
int main(int argc, char** argv) {
	...
	while (runloop) {
        ...
        Eigen::VectorXd command_torques = calcTorque(R_des, x_des, dof, robot, g);
