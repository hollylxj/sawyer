#include "../../sai2-common/src/model/ModelInterface.h"
...
//////////////////////
        ...
        */
        ...
        cout<< "torque to apply:" << command_torques<<endl;
        /*
...
void parseCommandline(int argc, char** argv) {
    ...
    if (argc != 4) {
        cout << "Usage: controller2 <path-to-world.urdf> <path-to-robot.urdf>" << endl;
        exit(0);
    }
